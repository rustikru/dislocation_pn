    ...
    $('#currentCarstree,#comingCarsTree').mousedown(function(event) {
        ...
        if (event.which === 3){ /*&&(cur_cars_tree_station === user_station_id ||(user_station_id==='2'&&cur_cars_tree_station==='1'))*/
			...
			*/
            ...
            if (r_add_attribute && $('.tree_selected').length===1 && clickedLi.hasClass('need_fill_attr')){
...
function md_change_cars_weight_net_new(p_type, p_loading_subs){
    ...
    function railcar_table_const_local(){
        ...
        this.add_cars_in_table = function(p_car_number,p_cont_number,p_freight_name,p_weight_net,p_weight_dep,p_weight_gross,p_arrive_weight_net,p_refusal,p_shop_info_id,p_railcar_type,p_car_tonnage
		,p_accepted_weight, p_define_task, p_define_comment
		){
			...
			tr.scales_type = get_select_scales_type_list(tr.scales_type,r_scale_type_1831_manual);
	...
	function get_select_scales_type_list(p_obj, p_scales_type){        
