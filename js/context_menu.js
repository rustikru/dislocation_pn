...
function md_change_cars_weight_net_new(p_type, p_loading_subs) {
  ...
  function md_change_cars_weight_net_ajax(
    ...
    var res
    //console.log('who_looked:'+p_who_looked);
    // console.log('who_start:'+p_who_start);
    //console.log('who_end:'+p_who_end);
    // console.log('who_zayavka:'+p_who_zayavka);
    // return;
    $.ajax({
      url: 'data.php',
      type: 'POST',
                ...
                .append(
                  $('<div>')
                    .append(
                      ...
                      }).text('Дата и время факта передачи уведомления (Мск)'),
                    )
