CREATE OR REPLACE package XX_ETW.xx_dislocation
    authid current_user
is
    /******************************************************************************
       name:
    ...
    ******************************************************************************/
    ...
    procedure log_new (p_log_id         number,
    ...
    function get_railways_name (p_railway_id number)
        return varchar2;
    ...
    /*возвращает подстроку в строке. Ввел для того чтобы символ "_" возвращал null*/
    ...
    type t_cars_table is table of varchar2 (100);

    type t_nums is table of number;

    /***************/
    type t_xx_credential_descr_table is table of xx_disl_credential%rowtype;
    ...
    type t_xx_user_descr_table is table of t_xx_user_descr_row;
    ...
    type t_xx_inv_table is table of t_xx_inv_row;
    ...
    (
        ...
        free_length              number,              /*свободная длина пути*/
    ...
    type t_xx_tree_table is table of t_xx_tree_row;
    ...
    type t_xx_railway_for_request_table
        is table of t_xx_railway_for_request_row;

    /***************/
    type t_xx_child_row_add_info
        is record
    (
        id                           varchar2 (100),
        ...
        un_loading_subs              varchar2 (10), -- Погрузка/Разгрузка при перемещении на конкретных путях
        inv_from_ugl                 varchar2 (50), -- Код Станции отправления
        cond_length_train            xx_etw.xx_disl_obj_add_info_tmp.cond_length_train%type -- add 26.09.2024 По наряду 0000064852 "Условная длина поезда"
    );

    type t_xx_child_table_add_info is table of t_xx_child_row_add_info;

    /***************/
    type t_xx_child_row_add_info_gu
        is record
    (
        id                   varchar2 (100),
        obj_type             varchar2 (20),
    ...
    type t_xx_child_table_add_info_gu is table of t_xx_child_row_add_info_gu;

    /***************/
    type t_xx_car_cont_add_info_row
        is record
    (
    ...
    type t_xx_car_cont_add_info_table is table of t_xx_car_cont_add_info_row;

    /***************/

    type t_xx_invoices is table of number;
    ...
    type t_xx_coming_car_table is table of t_xx_coming_car_row;
    ...
    (
        ...
        export_samples              varchar2 (1),      -- Создание проб в OeBS
        entry_foreign_cont          varchar2 (1)    -- Ручной ввод контейнеров
    );

    type t_xx_user_table is table of t_xx_user_row;
    ...
    type t_xx_station_table is table of t_xx_station_row;
    ...
    type t_xx_id_name_table is table of t_xx_id_name_row;
    ...
    type t_xx_id_name_addition_table is table of t_xx_id_name_addition_row;

    /***************/
    type t_xx_railway_info_table is table of xx_disl_railways%rowtype;

    /***************/
    type t_xx_freight_list_table is table of xx_disl_freight_list_v%rowtype;

    /***************/
    type t_xx_scales_type_list_table
        is table of xx_disl_scales_type_v%rowtype;

    /***************/
    type t_xx_car_type_list_table is table of xx_disl_car_type_list%rowtype;

    /***************/
    type t_xx_train_drivers is table of xx_disl_train_drivers%rowtype;

    /***************/
    type t_xx_conductors is table of xx_disl_conductors%rowtype;

    /***************/
    type t_xx_locomotives is table of xx_disl_locomotives%rowtype;

    /***************/
    type t_xx_car_numbers is table of xx_disl_round.railcar_id%type;

    /***************/
    type t_xx_org_list_table is table of xx_disl_organisation%rowtype;
    ...
    type t_xx_location_of_car_table is table of t_xx_location_of_car_row;
    ...
    type t_xx_report_1_table is table of t_xx_report_1_row;
    ...
    type t_xx_report_2_table is table of t_xx_report_2_row;
    ...
    type t_xx_report_3_table is table of t_xx_report_3_row;
    ...
    type t_xx_report_4_table is table of t_xx_report_4_row;

    function get_report_4_data (p_add_data in varchar2)
        return t_xx_report_4_table
        pipelined;

    type t_xx_notification_table
        is table of xx_disl_notification_save%rowtype;

    /***************/
    type t_xx_car_from_shop_row
        is record
    (
        id                      number,
    ...
    type t_xx_car_from_shop_table is table of t_xx_car_from_shop_row;
    ...
    type t_xx_cont_table is table of t_xx_cont_row;

    /***************/
    /******** beg Осмотр вагонов*******/
    /*beg Место осмотра вагонов*/
    type t_xx_place_row
        is record
    (
        flex_value            apps.fnd_flex_values_vl.flex_value%type,
        flex_value_meaning    apps.fnd_flex_values_vl.flex_value_meaning%type,
        description           apps.fnd_flex_values_vl.description%type
    );

    type t_xx_place_table is table of t_xx_place_row;

    function get_place_inspection_cars
        return t_xx_place_table
        pipelined;

    /*end Место осмотра вагонов*/

    /*beg Осмотр произвел ФИО*/
    ...
    type t_xx_person_table is table of t_xx_person_row;

    function get_inspection_persons
        return t_xx_person_table
        pipelined;

    /*end Место осмотра вагонов*/

    /*beg Мастер смены ФИО*/
    ...
    type t_xx_master_table is table of t_xx_master_row;

    function get_masters
        return t_xx_master_table
        pipelined;

    /*end Мастер смены ФИО*/
    ...
    (
        ...
        asset_group       inv.mtl_system_items_b.segment1%type,
        asset_number      csi.csi_item_instances.serial_number%type
    );

    type t_xx_asset_info_table is table of t_xx_asset_info_row;
    ...
    type t_xx_priority_table is table of t_xx_priority_row;

    function get_priority
        return t_xx_priority_table
        pipelined;

    /*end Приоритет*/

    /*beg Результат осмотра*/
    ...
    type t_xx_ins_result_table is table of t_xx_ins_result_row;

    function get_ins_results
        return t_xx_ins_result_table
        pipelined;

    /*end Результат осмотра*/
    ...
    type t_xx_status_kurs_table is table of t_xx_status_kurs_row;

    function get_status_kurs
        return t_xx_status_kurs_table
        pipelined;
    ...
    type t_xx_defect_table is table of t_xx_defect_row;

    function get_defects
        return t_xx_defect_table
        pipelined;
    ...
    type t_xx_document_types_table is table of t_xx_document_types_row;

    function get_document_types
        return t_xx_document_types_table
        pipelined;
    ...
    type t_xx_period_table is table of t_xx_period_row;
    ...
    type t_xx_period_closing_table is table of t_xx_period_closing_row;

    /*
        Для вывода сообщению пользователю при планов.откл.доступа к сайту
    */
    ...
    type t_xx_msg_to_user_table is table of t_xx_msg_to_user_row;

    --  Для вывода сообщению пользователю при планов.откл.доступа к сайту
    function get_msg_to_users
        return t_xx_msg_to_user_table
        pipelined;
    ...
    function get_periods
        return t_xx_period_table
        pipelined;

    function get_obj_owner (p_obj_id number, p_obj_type varchar2)
        return varchar2;
    ...
    function get_user_full_name (p_user_id number)
        return varchar2;

    function get_define_task (p_define_task_id number)
        return varchar2;

    function save_period_status (p_period_id   number,
                                 p_oper_id     number,
                                 p_status_id   number,
                                 p_user_id     number)
        return varchar2;

    function check_open_period (p_oper_id number, p_date varchar2)
        return varchar2;

    /********* end Периоды *********/
    -- проверка дата (в открытом периоде или нет)
    function OpenPeriodCheck (p_org_id number, p_date date)
        return varchar;

    type t_xx_ins_doc_types_table is table of xx_disl_ins_doc_types%rowtype;

    function get_ins_doc_types
        return t_xx_ins_doc_types_table
        pipelined;

    function create_new_ins_doc_type
        return number;

    function change_ins_doc_type (p_type_id        number,
                                  p_name           varchar2,
                                  p_descr          varchar2,
    ...
    type t_xx_rail_services_rgd_table is table of t_xx_rail_services_rgd_row;

    function get_rail_services_rgd
        return t_xx_rail_services_rgd_table
        pipelined;

    function save_rail_service_rgd (p_user_id    number,
                                    p_id         number,
                                    p_code       varchar2,
                                    p_category   varchar2,
                                    p_beg_date   varchar2,
    ...
    type t_xx_rail_services_table is table of t_xx_rail_services_row;

    function get_rail_services
        return t_xx_rail_services_table
        pipelined;

    function save_rail_service (p_user_id          number,
                                p_id               number,
                                p_code             varchar2,
                                p_descr            varchar2,
    ...
    type t_xx_rail_contracts_table is table of t_xx_rail_contracts_row;

    function get_rail_contracts
        return t_xx_rail_contracts_table
        pipelined;

    function save_rail_contract (p_user_id               number,
                                 p_id                    number,
                                 p_num                   varchar2,
                                 p_descr                 varchar2,
                                 p_owner                 varchar2,
    ...
    type t_xx_rail_contract_dop_table is table of t_xx_rail_contract_dop_row;

    function get_rail_contract_dop
        return t_xx_rail_contract_dop_table
        pipelined;

    function save_rail_contract_dop (p_user_id       number,
                                     p_id            number,
                                     p_num           varchar2,
                                     p_descr         varchar2,
                                     p_beg_date      varchar2,
    ...
    type t_xx_parent_contracts_table is table of t_xx_parent_contracts_row;

    function get_rail_parent_contracts
        return t_xx_parent_contracts_table
        pipelined;

    function save_rail_contract_change (p_user_id       number,
                                        p_id            number,
                                        p_num           varchar2,
                                        p_descr         varchar2,
                                        p_beg_date      varchar2,
    ...
    type t_xx_rail_contract_serv_table
        is table of t_xx_rail_contract_service_row;

    function get_rail_contract_services
        return t_xx_rail_contract_serv_table
        pipelined;
    ...
    function save_rail_contract_services (p_user_id       number,
                                          p_id            number,
                                          p_contract_id   number,
                                          p_service_id    number,
                                          p_ei            varchar2,
    ...
    function return_child (p_parent_id     number,
                           p_parent_type   varchar2,
                           p_flagCome      varchar2)
        return t_xx_tree_table
        pipelined;

    function get_tree_station (p_station_id   varchar2,
    ...
    function change_order_for_railway (p_id       number,
                                       p_type     varchar2,
                                       p_action   varchar2)
        return varchar2;
    ...
    function move_inside_station (p_user_id           number,
                                  p_car               varchar2,
    ...
    function move_inside_station_few_child (p_user_id          number,
                                            p_cars             varchar2,
                                            p_parent_id        number,
                                            p_parent_type      varchar2,
                                            p_operation_date   varchar2,
    ...
    function addBandwagon (p_name         varchar2,
                           p_parentId     number,
    ...
    function return_child_add_info
        return t_xx_child_table_add_info
        pipelined;

    function return_child_add_info_for_gu
        return t_xx_child_table_add_info_gu
        pipelined;

    procedure add_cars_for_add_info_tbl (p_id           varchar2,
                                         p_type         varchar2,
                                         p_station_id   number);

    procedure add_cars_for_add_info_tbl (p_car_numbers varchar2);

    procedure add_cars_for_add_info_tbl_r (p_car_numbers varchar2); /*список вагонов с round_id*/

    procedure add_car_for_add_info_tbl (p_car_number varchar2);

    procedure add_cont_for_add_info_tbl (p_cont_number varchar2);

    procedure return_child_add_info_bef (p_info_type number default 0);

    function get_shop_not_end_flag (p_shop_info_id   number,
                                    p_round_id       number,
    ...
    procedure populate_car_cont_tbl (p_only_cars   number default 0,
                                     p_user_id     number default null);

    function get_car_cont_add_info
        return t_xx_car_cont_add_info_table
        pipelined;
    ...
    function receive_into_station (p_user_id            number,
                                   p_car                varchar2,
                                   p_new_parent_id      number,
                                   p_new_parent_type    varchar2,
    ...
    function receive_into_station_few_child (p_user_id           number,
                                             p_cars              varchar2,
                                             p_new_parent_id     number,
                                             p_new_parent_type   varchar2,
                                             p_bef_aft           varchar2,
    ...
    function send_to_station (p_user_id           number,
                              p_car_id            varchar2,
    ...
    procedure update_cars_for_ugl (p_errbuf       out nocopy varchar2,
                                   p_retcode      out nocopy varchar2);

    function returnMaxOrder (p_id         varchar2,
                             p_type       varchar2,
                             p_flagCome   varchar2)
        return number;

    procedure deleteFromRelations (p_id          varchar2,
                                   p_type        varchar2,
                                   p_flag_come   varchar2);
    ...
    function send_from_ugl (p_user_id   number,
                            p_id        varchar2,
                            p_date      varchar2,
                            p_comment   varchar2)
        return varchar2;

    function send_cars_from_ugl (p_user_id    number,
                                 p_id_types   varchar2,
                                 p_date       varchar2,
                                 p_comment    varchar2)
        return varchar2;

    function entry_foreign_railcar (p_user_id     number,
                                    p_railcars    varchar2,
    ...
    function fill_railcar_attr (p_car_number     varchar2,
                                p_car_type       varchar2,
                                p_freight_name   varchar2)
        return varchar2;

    function fill_railcar_for_invoice (p_user_id      number,
                                       p_invoice_id   number,
                                       p_car_number   varchar2)
        return varchar2;

    function returnBadInvoices
        return t_xx_inv_table
        pipelined;

    function returnCountBadInvoices
        return number;

    function add_railway (p_parent_id       number,
                          p_parent_type     varchar2,
                          p_number          varchar2,
                          p_purpose         varchar2,
    ...
    function change_railway_attr (p_railway_id      number,
                                  p_number          varchar2,
                                  p_purpose         varchar2,
                                  p_pointer_from    varchar2,
                                  p_pointer_to      varchar2,
    ...
    function change_parent_for_railway (p_id                varchar2,
                                        p_type              varchar2,
    ...
    function getCarType (p_code_etsng    varchar2,
                         p_cont_number   varchar2,
                         p_type          varchar2 default null)
        return varchar2;

    function getCarFreight (p_code_etsng    varchar2,
                            p_cont_number   varchar2,
                            p_freight       varchar2 default null)
        return varchar2;

    procedure nrb_stop_update_prc (p_errbuf       out nocopy varchar2,
                                   p_retcode      out nocopy varchar2);
    ...
    procedure fill_railcar_add_info (p_round_id        number,
                                     p_add_info_type   varchar2);

    procedure update_railcars_add_info (p_errbuf       out nocopy varchar2,
                                        p_retcode      out nocopy varchar2);

    function get_freight_list
        return t_xx_freight_list_table
        pipelined;

    function get_org_name_list
        return t_xx_org_list_table
        pipelined;

    function get_car_type_list
        return t_xx_car_type_list_table
        pipelined;

    function change_railcar_add_info (p_user_id        number,
                                      p_car_number     varchar2,
                                      p_car_type       varchar2,
                                      p_freight_name   varchar2,
    ...
    function change_cont_add_info (p_user_id        number,
                                   p_cont_number    varchar2,
                                   p_freight_name   varchar2,
                                   p_weight_dep     varchar2,
                                   p_owner          varchar2)
    ...
    function get_train_drivers
        return t_xx_train_drivers
        pipelined;

    function get_conductors
        return t_xx_conductors
        pipelined;

    function get_locomotives
        return t_xx_locomotives
        pipelined;
    ...
    function register_notification (p_user_id                       number,
                                    p_cars                          varchar2,
    ...
    function save_notification (p_user_id                       number,
                                p_notification_name             varchar2,
                                p_cars                          varchar2,
                                p_notification_time_from        varchar2,
                                p_notification_person_from      varchar2,
    ...
    (
        ...
        not_number_etran    xx_etw.etw_cargo_end_ntf.cargo_end_notification_number%type,
        not_state_etran     xx_etw.etw_cargo_end_ntf.crg_state%type,
    ...
    type t_xx_contract_gu_table is table of t_xx_contract_gu_row;
    ...
    function get_report_1_data
        return t_xx_report_1_table
        pipelined;

    function get_report_2_data
        return t_xx_report_2_table
        pipelined;

    -- add 18.03.2024
    function get_report_3_data
        return t_xx_report_3_table
        pipelined;
    ...
    function add_point (p_parent_id     number,
                        p_parent_type   varchar2,
                        p_name          varchar2,
                        p_descr         varchar2)
        return number;

    function add_area (p_parent_id     number,
                       p_parent_type   varchar2,
                       p_name          varchar2,
                       p_descr         varchar2)
        return number;
    ...
    procedure update_shop_info (p_errbuf       out nocopy varchar2,
                                p_retcode      out nocopy varchar2);

    function toggle_like_railway (p_user_id    number,
                                  p_obj_id     number,
                                  p_obj_type   varchar)
        return varchar2;
    ...
    type t_loading_table is table of t_loadnig_rec;
    ...
    function get_cont_out_date (p_cont varchar2)
        return varchar2;

    function get_railcar_in_date (p_cars varchar2)
        return varchar2;

    function get_move_cont_to_pl (p_cars varchar2)
        return varchar2;
    ...
    function get_cars_from_shop (p_user_id        number,
    ...
    function get_cars_from_shop_for_oebs (p_user_id     number,
                                          p_freight     varchar2,
    ...
    /*отмечаем последнию запись для осмотров*/
    /*для ускорения выборки из таблицы последнего осмотра*/
    ...
    type t_xx_car_inspection_table is table of t_xx_car_inspection_row;
    ...
    procedure create_work_request (p_user_id             number,
                                   p_inspection_id       number,
                                   p_result          out varchar2,
                                   p_error_log       out varchar2);

    procedure create_work_dev_request (p_user_id             number,
                                       p_inspection_id       number,
                                       p_result          out varchar2,
                                       p_error_log       out varchar2);

    function refusal_to_repair (p_user_id         number,
                                p_inspection_id   number,
                                p_person          varchar2)
        return varchar2;

    /***************/
    type t_xx_credential_table is table of xx_disl_credential%rowtype;
    ...
    type t_xx_creden_descr_new_table is table of t_xx_creden_descr_new_row;
    ...
    */
    ...
    (
        ...
        p_export_samples              varchar2 (240)   -- Создание проб в OeBS
                                                    ,
        p_entry_foreign_cont          varchar2 (240) -- Ручной ввод контейнеров
    );
    ...
    function delete_credential (p_credential_id number)
        return varchar2;
    ...
    function add_user (p_login             varchar2,
    ...
    function change_user (p_user_id           number,
                          p_login             varchar2,
                          p_full_name         varchar2,
                          p_enterprise        number,
                          p_division          number,
    ...
    type t_xx_request_table is table of t_xx_request_row;
    ...
    --return number;
    function get_info_for_car_request (p_car_number   varchar2,
                                       p_info_type    number)
        return varchar2;

    function create_request (p_user_id        number,
                             p_request_task   number,
                             p_crit_task      varchar2,
                             p_cars_mas       t_cars_table)
        return number;

    function save_request (p_user_id             number,
                           p_request_id          number,
    ...
    function close_request (p_user_id      number,
                            p_car_number   varchar2,
                            p_task_id      number,
                            p_comment      varchar2,
                            p_date         varchar2)
    ...
    type t_xx_request_car_table is table of t_xx_request_car;

    function get_request_criteria_cars_new (p_criteria_id number)
        return t_xx_request_car_table
        pipelined;

    function save_request_status (p_user_id        number,
                                  p_request_id     number,
                                  p_status         varchar2,
    ...
    function save_car_complete_for_request (p_user_id       number,
                                            p_criteria_id   number,
                                            p_car_number    number,
                                            p_complete      number)
        return varchar2;

    function save_crit_complete_for_request (p_user_id       number,
                                             p_criteria_id   number,
                                             p_complete      number)
        return varchar2;

    function save_car_close_for_request (p_user_id       number,
                                         p_criteria_id   number,
                                         p_car_number    number,
                                         p_close         number,
                                         p_comment       varchar2)
    ...
    function save_crit_close_for_request (p_user_id       number,
                                          p_criteria_id   number,
                                          p_close         number,
                                          p_comment       varchar2)
        return varchar2;

    function get_railway_for_car (p_car_number   varchar2,
                                  p_name         number default 0)
        return varchar2;

    function get_stations_for_railway (p_railway   varchar2,
                                       p_name      number default 0)
        return varchar2;

    function get_cars_with_railways (p_cars           varchar2,
                                     p_need_railway   varchar2 default 'Y')
        return varchar2;

    function save_send_to_station_form (p_user_id           number,
                                        p_name              varchar2,
    ...
    type t_xx_saved_elem_table is table of send_to_station_form_save%rowtype;

    function load_send_to_station_form (p_name varchar2)
        return t_xx_saved_elem_table
        pipelined;

    function del_send_to_station_form (p_user_id number, p_name varchar2)
        return varchar2;
    ...
    /***************/
    function get_request_data (p_request_id   number,
    ...
    function get_last_cars_train_time (p_car_numbers   varchar2,
                                       p_reason        varchar2)
        return varchar2;

    function return_from_psp (p_user_id                    number,
    ...
    type t_xx_car_scale_weight_table is table of t_xx_car_scale_weight_row;

    function get_car_scale_weights
        return t_xx_car_scale_weight_table
        pipelined;

    function load_car_scale_weights (p_user_id       number,
                                     p_train_id      number,
    ...
    type t_xx_car_scale_weight_tbl_add
        is table of t_xx_car_scale_weight_row_add;
    ...
    function save_change_weight_car (p_user_id number, p_add_data varchar2)
        return varchar2;
    ...
    function move_conts (p_user_id      number,
                         p_conts        varchar2,
                         p_place_id     number,
    ...
    function move_cont (p_user_id             number,
                        p_cont_number         varchar2,
                        p_place_id            number,
                        p_place_type          varchar2,
                        p_oper_date           date,
    ...
    type t_xx_graph_pod_table is table of t_xx_graph_pod_row;
    ...
    type t_xx_claim_otpr_table is table of t_xx_claim_otpr_row;
    ...
    type t_xx_recip_address_table is table of t_xx_recip_address_row;

    type t_xx_claim_info_row
        is record
    (
    ...
    type t_xx_claim_info_table is table of t_xx_claim_info_row;

    type t_xx_cont_csl_row is record
    (
        cont_number           xx_etw.etw_inv_cont.cont_number%type,
        seal_type_id          xx_etw.etw_inv_cont_csl.seal_type_id%type,
        seal_marks            xx_etw.etw_inv_cont_csl.seal_marks%type,
        seal_quantity         xx_etw.etw_inv_cont_csl.seal_quantity%type,
        seal_year             xx_etw.etw_inv_cont_csl.seal_year%type,
        seal_owner_type_id    xx_etw.etw_inv_cont_csl.seal_owner_type_id%type
    );

    type t_xx_cont_csl_table is table of t_xx_cont_csl_row;

    function create_return_invoice_adapter (p_user_id            number,
                                            p_car_number         varchar2,
                                            p_otpr_nom           number,
                                            p_graph              varchar2,
    ...
    function create_return_invoice (p_user_id            number,
                                    p_round_id           number,
                                    p_otpr_nom           number,
                                    p_graph              varchar2,
                                    p_recip_address_id   number,
    ...
    function enter_claim (p_user_id        number,
                          p_car_number     varchar2,
    ...
    type t_xx_route_table is table of xx_disl_loco_routes_v%rowtype;
    ...
    type t_xx_locomotives_table is table of t_xx_locomotives_row;

    function get_locomotives_from_oebs
        return t_xx_locomotives_table
        pipelined;

    function save_route (p_user_id           number,
                         p_route_id          number,
                         p_date_from         varchar2,
                         p_date_to           varchar2,
                         p_status            number,
    ...
    function save_route_status (p_user_id        number,
                                p_route_id       number,
                                p_status         number,
                                p_status_descr   varchar2)
        return varchar2;

    function get_flag_route_closed (p_route_id number)
        return varchar2;

    function get_routes (p_date_from   varchar2,
                         p_date_to     varchar2,
                         p_smena       number,
                         p_station     number,
                         p_loco        number)
    ...
    type t_xx_route_action_table is table of t_xx_route_action_row;
    ...
    function get_route_actions (p_date_from      varchar2,
                                p_date_to        varchar2,
                                p_station_id     number,
                                p_operation      number,
    ...
    function get_obj_freight (p_obj_id     number,
                              p_obj_type   varchar2,
                              p_date       date)
        return varchar2;

    function get_suitable_routes (p_date varchar2, p_enter_text varchar2)
        return t_xx_id_name_table
        pipelined;

    function save_route_links (p_user_id     number,
                               p_actions     varchar2,
                               p_routes      varchar2,
                               p_date_from   varchar2,
                               p_date_to     varchar2)
    ...
    function del_route_links (p_user_id number, p_actions varchar2)
        return varchar2;

    function get_other_actions (p_date_from    varchar2,
                                p_date_to      varchar2,
                                p_station_id   number,
                                p_operation    number,
                                p_route        number,
    ...
    function save_other_actions (p_user_id           number,
                                 p_action_id         number,
                                 p_date_from         varchar2,
                                 p_date_to           varchar2,
                                 p_routes            varchar2,
    ...
    function del_other_actions (p_user_id number, p_actions varchar2)
        return varchar2;
    ...
    type t_xx_route_total_table is table of t_xx_route_total_row;

    function get_route_work_time (p_route_id number, p_oper_type number)
        return number;

    function get_routes_totals (p_date_from   varchar2,
                                p_date_to     varchar2,
                                p_smena       number,
                                p_station     number,
                                p_loco        number)
    ...
    type t_xx_route_operation_table is table of t_xx_route_operation_row;

    function get_route_operation_details (p_route_id number)
        return t_xx_route_operation_table
        pipelined;

    function save_route_add (p_user_id        number,
                             p_route_id       number,
                             p_fuel_in        varchar2,
                             p_fuel_out       varchar2,
                             p_waiting        number,
    ...
    function output_car (p_user_id   number,
                         p_id        varchar2,
                         p_date      varchar2,
                         p_comment   varchar2)
        return varchar2;

    function output_cars (p_user_id    number,
                          p_id_types   varchar2,
                          p_date       varchar2,
                          p_comment    varchar2)
        return varchar2;
    ...
    type t_xx_car_passport_table is table of t_xx_car_passport_row;

    function get_cars_passport (p_user_id number, p_cars varchar2)
        return t_xx_car_passport_table
        pipelined;

    procedure update_cars_nsi (p_errbuf       out nocopy varchar2,
                               p_retcode      out nocopy varchar2);

    /*beg***************  Расходные нормы ГСМ  ******************/
    type t_fuel_loco_table
        is table of xx_etw.xx_disl_loco_add_from_oebs_v%rowtype;

    type t_fuel_standart_spr_table
        is table of xx_etw.xx_disl_fuel_standart_spr%rowtype;

    function get_fuel_loco
        return t_fuel_loco_table
        pipelined;

    function get_fuel_standart_spr
        return t_fuel_standart_spr_table
        pipelined;

    function save_fuel_standart (p_user_id    number,
                                 p_row_id     number,
                                 p_add_data   varchar2)
        return varchar2;

    type t_xx_fuel_standart_table is table of xx_disl_fuel_standart_v%rowtype;

    function get_fuel_standart (p_params varchar2)
        return t_xx_fuel_standart_table
        pipelined;

    /*end***************  Расходные нормы ГСМ  ******************/

    /*beg***************  Нормы закрепления  ******************/
    function get_fixing_side (p_user_id number)
        return t_xx_id_name_table
        pipelined;

    function get_railway_part (p_user_id number, p_railway_id number)
        return t_xx_id_name_table
        pipelined;

    function save_railway_part (p_user_id    number,
                                p_part_id    number,
                                p_add_data   varchar2)
        return varchar2;
    ...
    type t_xx_fixing_device_rule_table
        is table of t_xx_fixing_device_rule_row;

    function save_fixing_device_rule (p_user_id number, p_add_data varchar2)
        return varchar2;

    function get_fixing_device_rule (p_user_id number, p_params varchar2)
        return t_xx_fixing_device_rule_table
        pipelined;

    function get_fixing_device (p_user_id number, p_params varchar2)
        return t_xx_id_name_table
        pipelined;

    function get_parent_storage_place (p_user_id number, p_params varchar2)
        return t_xx_id_name_table
        pipelined;

    function save_storage_place (p_user_id number, p_add_data varchar2)
        return varchar2;
    ...
    (
        ...
        con_person_mas            clob, --varchar2(4000), -- Кто проводит снятие/закрепление
        con_person_str            varchar2 (4000),
        rep_person_mas            clob, --varchar2(4000), -- Кто докладывает снятие/закрепление
        rep_person_str            varchar2 (4000),
        res_person_mas            clob, --varchar2(4000), -- Ответственный за прием/сдачу смены
        res_person_str            varchar2 (4000),
        device_str                clob,                      --varchar2(4000),
        last_update_date          varchar2 (100)
    );

    type t_xx_storage_place_table is table of t_xx_storage_place_row;

    function get_storage_place (p_user_id number, p_params varchar2)
    ...
    type t_xx_car_info_fd_table is table of t_xx_car_info_fd_row;

    function get_railway_parts (p_user_id number, p_params varchar2)
        return t_xx_id_name_table
        pipelined;

    function get_railway_cars (p_user_id number, p_params varchar2)
        return t_xx_car_info_fd_table
        pipelined;

    function get_suitable_device_rules (p_user_id number, p_params varchar2)
        return varchar2;
    ...
    type t_xx_car_info_fd_upd_table is table of t_xx_car_info_fd_upd_row;

    function get_railway_cars_for_upd (p_user_id number, p_params varchar2)
        return t_xx_car_info_fd_upd_table
        pipelined;

    /*end***************  Нормы закрепления  ******************/


    /*******************  Назначение ЗУ      ******************/

    /*Кто проводит (select)*/
    function get_users_for_cond_train (p_user_id number, p_params varchar2)
        return t_xx_id_name_table
        pipelined;
    ...
    type t_xx_device_for_table is table of t_xx_device_for_assignment_row;
    ...
    type t_xx_users_for_cond_table is table of t_xx_users_for_cond_row;

    /*Кто проводит (select)*/
    function set_users_for_cond_train (p_user_id number, p_params varchar2)
        return t_xx_users_for_cond_table
        pipelined;

    function get_device_for_assignment (p_user_id number, p_params varchar2)
    ...
    type t_xx_device_update_table is table of t_xx_device_for_update_row;

    function get_device_for_update (p_user_id number, p_params varchar2)
    ...
    type t_xx_car_color_table is table of t_xx_car_color_row;

    function get_car_color_select (p_user_id number, p_params varchar2)
        return t_xx_car_color_table
        pipelined;

    -- ****** ********************** --
    /*Транзакции закрепления ЗУ*/
    function save_transaction_fix_device (p_user_id    number,
                                          p_add_data   varchar2)
        return varchar2;
    ...
    type t_xx_side_table is table of t_xx_side_row;

    function get_side_for_device (p_user_id number, p_params varchar2)
        return t_xx_side_table
        pipelined;

    -- Возвращет кол-во закрепленных башмаков на пути
    function get_count_fix_dev (p_railway_id number, p_side_type varchar2)
        return number;

    -- Проверка назначеных башмаков.Если башмаки закреплены на путях -> выводим список путей
    function validation_dev_trans (p_railway_id    number default null,
                                   p_part_id       number default null,
                                   p_instance_id   number,
                                   p_not           varchar2 default 'N')
        return varchar2;

    function validation_ondock (p_user_id number, p_params varchar2)
        return varchar2;

    function validation_fix (p_user_id number, p_params varchar2)
        return varchar2;
    ...
    type t_xx_dev_ondock_table is table of t_xx_dev_ondock_row;

    function get_device_for_ondock (p_user_id number, p_params varchar2)
        return t_xx_dev_ondock_table
        pipelined;


    /*Транзакции открепления ЗУ*/
    function save_transaction_ondock (p_user_id number, p_add_data varchar2)
        return varchar2;

    /* Удаляем (помечаем) ЗУ.*/
    function delete_fix (p_user_id number, p_add_data varchar2)
        return varchar2;

    -- Значения Header закрепления
    ...
    type t_xx_header_value_fix_table is table of t_xx_header_value_fix_row;

    function set_header_value_fix (p_user_id number, p_params varchar2)
    ...
    /*Транзакции закрепления ЗУ*/
    function update_transaction_fix_device (p_user_id    number,
                                            p_add_data   varchar2)
        return varchar2;

    /***********************************************************/
    /*********** Осмотры ЗУ ************************************/
    function get_device_id (p_user_id number, p_params varchar2)
        return t_xx_id_name_table
        pipelined;
    ...
    type t_xx_defect_dev_table is table of t_xx_defect_dev_row;

    function get_device_defects
        return t_xx_defect_dev_table
        pipelined;

    /*end Неисправность*/


    function enter_dev_inspection (p_user_id       number,
                                   p_add_data      varchar2,
                                   p_need_commit   varchar2 default 'Y')
        return varchar2;

    type t_xx_car_dev_inspection_row
        is record
    (
        inspection_id                number,
    ...
    type t_xx_car_dev_inspection_table
        is table of t_xx_car_dev_inspection_row;

    function get_car_dev_inspections (p_obj_number   varchar2,
                                      p_obj_type     varchar2)
        return t_xx_car_dev_inspection_table
        pipelined;

    function refusal_dev_to_repair (p_user_id         number,
                                    p_inspection_id   number,
                                    p_person          varchar2)
        return varchar2;
    ...
    type t_xx_snapshot_wagon_table is table of t_xx_snapshot_wagon_row;

    function get_snapshot_wagon (p_user_id number, p_params varchar2)
        return t_xx_snapshot_wagon_table
        pipelined;


    function get_status_shift (p_user_id number, p_params varchar2)
        return t_xx_id_name_table
        pipelined;

    -- Сохраняем данные с сдачи-приема смены
    function save_shift_change (p_user_id number, p_add_data clob)
        return varchar2;

    type t_xx_smena_change_table is table of xx_disl_smena_change_v%rowtype;

    function get_smena_change (p_user_id number, p_params varchar2)
    ...
    function save_shift_status (p_user_id number, p_add_data clob)
        return varchar2;
    ...
    type t_xx_route_smena_change_table
        is table of t_xx_route_smena_change_row;

    function get_route_smena_change
        return t_xx_route_smena_change_table
        pipelined;
    ...
    type t_xx_control_table is table of t_xx_control_row;

    -- Список вагонов на контроле
    function get_control_standart (p_params varchar2)
    ...
    type t_xx_control_code_cause_table
        is table of t_xx_control_code_cause_row;

    -- Контроль.Список причин
    function get_control_code_cause (p_params varchar2)
        return t_xx_control_code_cause_table
        pipelined;

    function save_control_car (p_user_id    number,
                               p_row_id     number,
                               p_add_data   varchar2)
        return varchar2;

    function delete_control_car (p_user_id    number,
                                 p_row_id     number,
                                 p_add_data   varchar2)
        return varchar2;
    ...
    function xx_is_number (p_number varchar)
        return boolean;

    function xx_is_date (p_value in varchar2, p_date_format in varchar2)
        return boolean;

    function get_sum (p_car_number number)
        return number;

    function check_car_number (p_car_number varchar)
        return number;
    ...
    type t_xx_disl_opm_trx_header_table
        is table of xx_etw.xx_disl_opm_trx_header_v%rowtype;

    type t_xx_disl_freight_oebs_table
        is table of xx_etw.xx_disl_freight_oebs_v%rowtype;


    type t_xx_process_of_wagons_row
        is record
    (
        disl_hdr_id            number,
    ...
    type t_xx_process_of_wagons_table is table of t_xx_process_of_wagons_row;
    ...
    type t_xx_process_of_wag_hist_table
        is table of t_xx_process_of_wag_hist_row;

    function get_opm_trx_header_id (p_line_id number)
        return number;
    ...
    *******************************************************************************/
    function get_process_of_wagons (p_params varchar2)
    ...
    Параметры:
      * p_params - массив данных в формет JSON
    *******************************************************************************/
    function get_process_of_wagons_history (p_params varchar2)
    ...
    *******************************************************************************/
    procedure save_process_of_wagons (p_user_id    in     number,
                                      p_add_data   in     clob,
                                      p_result        out varchar2);
    ...
    *******************************************************************************/
    ...
    Параметры:
      *
    /*******************************************************************************/
    function get_disl_freight_oebs (p_add_data varchar2)
    ...
    Параметры:
      ...
      * p_result - результат выполнения (массив): done - успешно
                                        fail$MessageError - ошибка$текст_ошибки
    *******************************************************************************/
    procedure run_process_of_wagons (p_user_id    in     number,
                                     p_add_data   in     clob,
                                     p_result        out varchar2);
    ...
    Параметры:
      * p_params - массив данных в формет JSON
    *******************************************************************************/
    function add_car_for_process_of_wagons (p_car_number in varchar2)
        return t_xx_process_of_wagons_table
        pipelined;

    /*********************************************************/

    function check_carnumber_in_db (p_car_number varchar2)
        return varchar2;

    function get_scales_type_list
        return t_xx_scales_type_list_table
        pipelined;
    ...
    function get_un_loading_type (p_type varchar2)
        return number;

    function get_define_task_list
        return t_xx_id_name_table
        pipelined;
    ...
    type t_xx_main_menu_table is table of t_xx_main_menu_row;

    function get_main_menu (p_user_id      varchar2,
                            p_station_id   varchar2,
                            p_part_site    varchar2 default 'main')
        return t_xx_main_menu_table
        pipelined;

    function xx_disl_last_railcar_info (p_round_id               number,
    ...
    */
    ...
    type t_xx_car_from_samples_table is table of t_xx_car_from_samples_row;
    ...
    type t_xx_product_table is table of t_xx_product_row;
    ...
    function get_specid_for_product (p_product varchar2)
        return number;
    ...
    */
    ...
    function get_disl_samples_info (p_add_data varchar2, p_user_id varchar2)
    ...
    type t_xx_sample_tbl_header_table is table of t_xx_sample_tbl_header_row;

    -- Функция возвращает шапку таблицы для формы "Export пробы в OeBS"
    function get_sample_tbl_header (p_add_data varchar2, p_user_id varchar2)
    ...
    (
        ...
        sample_code          apps.gmd_qc_tests_vl.test_code%type,
        result_value_char    gmd.gmd_results.result_value_char%type,
        result_value_num     gmd.gmd_results.result_value_num%type
    );

    type t_import_samples_tbl is table of t_import_samples_rwn
    ...
    function get_deliveri_name (p_car_number in varchar2)
        return varchar2;

    -- add 20.12.2023 BekmansurovRR
    -- Функция определяет, является ли вагон прицепной частью маршрута?
    function get_car_trailer_part (p_car_number     in varchar2,
                                   p_front_end_id   in varchar2,
                                   p_inv_number     in varchar2)
        return varchar2;

    -- add 20.12.2023 BekmansurovRR
    function get_trailer_part_color (p_trailer_part varchar2)
        return varchar2;

    type t_xx_product_list_table
        is table of xx_etw.xx_disl_product_name%rowtype;

    function get_product_name_list (p_section in varchar2 default null)
        return t_xx_product_list_table
        pipelined;

    type t_xx_loadind_status_oebs_table
        is table of xx_etw.xx_disl_loadind_status_oebs%rowtype;
    ...
    type t_xx_loadind_type_oebs_table
        is table of xx_etw.xx_disl_loadind_type_oebs%rowtype;

    function get_loadind_type_oebs_list (p_section in varchar2 default null)
        return t_xx_loadind_type_oebs_table
        pipelined;

    type t_xx_rights_list_table is table of xx_etw.xx_disl_rights%rowtype;

    function get_rights_list
        return t_xx_rights_list_table
        pipelined;

    function save_new_credential_new (p_user_id    in number,
                                      p_add_data   in varchar2)
        return varchar2;

    type t_xx_user_new_row
        is record
    (
        user_id                 number,
        full_name               varchar2 (100),
    ...
    type t_xx_user_new_table is table of t_xx_user_new_row;

    function return_user_data_new (p_login varchar2)
    ...
    type t_list_catalog_table is table of xx_etw.xx_disl_mdt_objects%rowtype;

    -- Список каталогов (справочников)
    function get_list_catalog
        return t_list_catalog_table
        pipelined;

    type t_list_attribute_table
        is table of xx_etw.xx_disl_mdt_object_attributes%rowtype;

    -- Список атрибутов для каталога(справочника)
    function get_attribute_for_catalog (p_object_id in number)
        return t_list_attribute_table
        pipelined;

    -- Сохранение данных
    procedure prc_save_catalog (p_user_id      in     varchar2,
    ...
    type t_source_for_column_table is table of t_source_for_column_row;

    -- Список значений для столбца с внешним источником
    function get_source_for_column (p_param_data in varchar2)
        return t_source_for_column_table
        pipelined;

    -- Возвращаем данные таблицы
    function get_combined_data (p_object_id in number)
    ...
    function get_request_id (p_request_id in number)
        return number;

    function get_request_status_d (p_request_id in number)
        return varchar2;

    function get_request_status_code (p_request_id in number)
        return varchar2;

    function get_users_id (p_login in varchar2)
        return number;

    function get_railway_id (p_railway_name in varchar2)
        return number;

    function get_request_tasks_name (p_task_id number)
        return varchar2;

    function get_criteria_tasks_name (p_task_id number)
        return varchar2;

    /***************** Модуль: Контроль простоев *******************************/
    ...
    type t_xx_idle_control_table is table of t_xx_idle_control_row;
    ...
    type t_xx_idle_reasons_table is table of t_xx_idle_reasons_row;
    
    function get_idle_reason_list return t_xx_idle_reasons_table
        pipelined;
    function get_idle_control_list (p_params varchar2)
        return t_xx_idle_control_table
        pipelined;

    function save_idle_control (p_user_id    number,
                                p_row_id     number,
                                p_add_data   varchar2)
        return varchar2;

    function delete_idle_control (p_user_id    number,
                                  p_row_id     number,
                                  p_add_data   varchar2)
        return varchar2;
/******************************************************************/
