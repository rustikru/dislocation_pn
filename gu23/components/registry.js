...
export function showArchive(container) {
  $(container).html(
    '<div class="phead">' +
      ...
      '<button id="btn-reset-filters" title="Сбросить фильтры" style="border:none;background:none;color:var(--muted);font-size:13px;cursor:pointer;padding:4px 2px">Сбросить</button>' +
      '</div>' +
