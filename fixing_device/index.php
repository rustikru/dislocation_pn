...
<html> 
    <head>
        ...
        <link rel="stylesheet" href="fixing_device.css" type="text/css">
        ...
        <script src="fixing_device.js?ver=3" type="text/javascript"></script>
    ...
    <body>
        <div class="wrapper">
            ...
            <div id="tabs" class="tabs">
                <ul>
                    <li><a href="#tabs-1">Нормы ЗУ</a></li>
					<li><a href="#tabs-2">Места хранения</a></li>
					
                </ul>
                
                
				<?php 
						if ($rights['fix_dev_rule']==='Y'||$rights['fix_dev_place']==='Y') {
					?>  <div id="tabs-1">
						</div>
