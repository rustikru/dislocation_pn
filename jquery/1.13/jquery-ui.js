...
$.widget( "ui.autocomplete", {
	...
	_create: function() {
		...
		this.menu = $( "<ul>" )
			.addClass( "ui-autocomplete ui-front" )
                        .css({'max-height':this.options.menuMaxHeight})
	...
	_renderItem: function( ul, item ) {
		...
		return $( "<li title='"+(item.title?item.title:'')+"' style='"+item.style+"' class='"+(item.disabled?'disabled':'')+"'>" ).text( item.label ).appendTo( ul );
	},
