...
<html> 
    <head>
        ...
        <link rel="stylesheet" href="shift_change.css" type="text/css">
        ...
        <script src="shift_change.js?ver=3" type="text/javascript"></script>
    ...
    <body>
        <div class="wrapper">
            ...
            <div id="tabs" class="tabs">
                <ul>
					<li><a href="#tabs-3">Прием-Сдача смены</a></li>
                </ul>
				<div id="tabs-3">
                </div>
            </div>
